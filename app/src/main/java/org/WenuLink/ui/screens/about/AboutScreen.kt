...
private fun AppIdentitySection() {
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Card(colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surfaceVariant)) {
            Text(
                text = "WenuLink is a middleware interface bridging DJI drones and Ground Control Stations (GCS) via MAVLink.",
    ...
    Card(
        ...
        Row(
            ...
            Column {
                ...
                Text(text = role, style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
            }
        }
    }
}